---
title: "aer13_PeerCommentary_nirmitin"
author: "Nirmiti Naik"
date: "11/18/2021"
...
**I like that you went further and looked at the residuals and QQ plot as well to see if there was any information you could gain from that.-NN**
```{r}
...
**Seems very useful to rename your variables and omitting the NAs seems to have made a difference since the values are slightly different than the ones I got.-NN**
```{r}
...
**Your approach at bootstrapping was quite different than mine since it seems like you got 10,000(?) B0 and B1 coefficients, one for each of your samples - I would assume that they would average out to a similar value you would get if you used the boot.ci function. I never considered bootstrapping or calculating the coefficients and CI this way so I'm interested to see how our values compare.-NN**
